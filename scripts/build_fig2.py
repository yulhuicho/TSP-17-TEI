"""
Build script for fig 2 · Pakṣa Length
Reads code_fig2.py and generates the notebook.
"""
import nbformat, os
from nbclient import NotebookClient

HERE = os.path.dirname(os.path.abspath(__file__))
CODE_FILE = f'{HERE}/code_fig2.py'
OUT_NB = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'notebooks', 'fig2_PakshaLength.ipynb')

with open(CODE_FILE, encoding='utf-8') as f:
    code = f.read()

MD = """# fig 2 · Pakṣa Length
